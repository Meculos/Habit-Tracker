...
ALLOWED_HOSTS = [ "localhost", "127.0.0.1", "habit-log.up.railway.app" ]

CSRF_TRUSTED_ORIGINS = [ "https://habit-log.up.railway.app" ]
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # For app-level static files
...
LOGGING = {
    ...
    'loggers': {
        ...
        'habit_tracker': {  # Replace 'habit_tracker' with your app name
            'handlers': ['console'],
            'level': 'DEBUG',
            'propagate': False,
        },
